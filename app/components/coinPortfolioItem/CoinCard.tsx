        ...
        <div className={clsx("w-[calc(75%+2rem)] p-5",{
          ...
          <div>
            <div className="flex justify-between mb-2 mt-4 rounded-[22px]">
              ...
              })} onClick={()=>toggleDeleteModal(coinData)} >
          ...
          <div>
            <div className="flex justify-between mt-4 mb-2">
              ...
              <svg onClick={()=>toggleEditModal(storageData.id)} className="cursor-pointer hover:opacity-70 hover:border-cryptoblue-800 hover:border-[1px] box-border hover:rounded" width="30" height="30" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
