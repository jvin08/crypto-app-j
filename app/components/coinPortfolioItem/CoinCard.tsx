        ...
        <div className={clsx("w-[calc(80%+2rem)] p-5",{
          ...
          <div>
            <div className="flex justify-between mt-4 mb-2">
              ...
              <svg onClick={(e)=>toggleEditModal(e, storageData.id)} className="cursor-pointer hover:opacity-70 hover:border-cryptoblue-800 hover:border-[1px] box-border hover:rounded" width="30" height="30" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
